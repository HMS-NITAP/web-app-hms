...
import FirstYearStudentApplicationCard from '../../components/Admin/FirstYearStudentApplicationCard';

const FirstYearRegistrationApplications = () => {
    ...
    <div className="w-full flex flex-col items-center px-4 py-6">
      ...
      <div className="w-full flex md:flex-row flex-wrap flex-col justify-center items-stretch gap-4">
        {applications.map((application, index) => (
          <FirstYearStudentApplicationCard
            key={index}
...
export default FirstYearRegistrationApplications